...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/w68-home.css') }}?v=20260914-v52">
    <script src="{{ asset('js/w68-home.js') }}?v=20260914-v52" defer></script>
</head>
<body
    ...
    data-server-cart="{{ e(json_encode($serverCart ?? [], JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_AMP | JSON_HEX_QUOT)) }}"
    ...
    @php
        ...
        $productData = function ($product) use ($currentProductImageBase) {
            return [
                ...
                'discountPercent' => number_format((float) ($product->discount_percent ?? 0), 2, '.', ''),
                'discountedPrice' => number_format((float) ($product->discounted_price ?? $product->display_price ?? $product->selling_price ?? 0), 2, '.', ''),
        ...
        <section class="detail-modal-card" role="dialog" aria-modal="true" aria-labelledby="product-modal-title">
            ...
            <div class="detail-modal-content">
                ...
                <div class="detail-list">
                    ...
                    <div><span>Specification</span><strong data-product-modal-specification>&mdash;</strong></div>
        ...
        <section class="detail-modal-card" role="dialog" aria-modal="true">
            ...
            <div class="detail-modal-content">
                ...
                <div class="detail-list">
                    ...
                    <div><span>Specification</span><strong data-cart-item-modal-specification>&mdash;</strong></div>
                ...
                <div class="cart-order-summary">
                    ...
                    <div data-cart-item-modal-discount-row hidden><span>DISCOUNTED PRICE</span><strong data-cart-item-modal-discounted-price>0.00</strong></div>
