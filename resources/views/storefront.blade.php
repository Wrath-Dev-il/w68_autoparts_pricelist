...
<body>
                    ...
                    <article class="hero-product-slide hero-logo-slide active" data-slide>
                        <div class="hero-logo-slide-copy">
                            ...
                            <div class="hero-actions">
                                <a class="primary-action" href="{{ route('storefront') }}#products" data-shop-parts>Browse Products</a>
                                <a class="secondary-action" href="{{ route('storefront') }}#products" data-shop-parts>Shop Parts</a>
                            </div>
                        </div>
                            ...
                            <div class="hero-product-copy hero-product-copy-minimal">
                                ...
                                <div class="hero-actions">
                                    <a
                                        ...
                                        href="{{ route('storefront', ['product_id' => $product->id]) }}#product-{{ $product->id }}"
                                        data-browse-product
    ...
    <script src="{{ asset('js/w68-storefront.js') }}?v=20260911-v14" defer></script>
</body>
</html>
