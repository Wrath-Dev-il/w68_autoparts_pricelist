...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/w68-storefront.css') }}?v=20260911-v5">
</head>
<body>
    ...
    <main>
        <section class="shell hero-grid">
            <div class="hero-main hero-product-carousel" id="hero-new-items" data-slide-carousel data-interval="2000">
                @if (count($newItems))
                    <div class="hero-product-slides">
                        @foreach ($newItems as $index => $product)
                            <article class="hero-product-slide {{ $index === 0 ? 'active' : '' }}" data-slide>
                                <div class="hero-product-copy">
                                    ...
                                    <div class="hero-product-meta">
                                        ...
                                        @if ($product->part_number)<span>Part No. {{ $product->part_number }}</span>@endif
                                    ...
                                    <div class="hero-product-bottom">
                                        ...
                                        <button type="button" class="add-cart hero-main-add" data-add-cart data-id="{{ $product->id }}" data-name="{{ $product->name }}" data-price="{{ $product->display_price }}">Add to Cart</button>
                                    </div>
                                ...
                                <div class="hero-product-visual">
                                    ...
                                    <div class="hero-product-image-wrap">
                                        <img class="hero-product-image" src="{{ $product->image_url ?: asset('build/assets/images/sidebar_logo.png') }}" alt="{{ $product->name }}" loading="lazy" onerror="this.src='{{ asset('build/assets/images/sidebar_logo.png') }}'">
                                    </div>
                                </div>
                            </article>
                        @endforeach
                    ...
                    @if (count($newItems) > 1)
                        <button class="hero-main-arrow previous" type="button" data-slide-prev aria-label="Previous new item">‹</button>
                        <button class="hero-main-arrow next" type="button" data-slide-next aria-label="Next new item">›</button>
                        <div class="hero-carousel-label">NEW ITEM {{ date('Y') }} • rotates every 2 seconds</div>
                    @endif
                @else
                    <div class="hero-product-slide active empty-hero-slide">
                        <div class="hero-product-copy">
                            <span class="eyebrow">NEW ITEM {{ date('Y') }}</span>
                            <h1>W68 Autoparts</h1>
                            <p>Newly added items for {{ date('Y') }} will appear here.</p>
                            <div class="hero-actions">
                                <a class="primary-action" href="#products">Shop Parts</a>
                                <a class="secondary-action" href="#brands">Browse Brands</a>
                            </div>
                        ...
                        <div class="hero-product-visual">
                            <div class="hero-logo-watermark visible-logo"><img src="{{ asset('build/assets/images/sidebar_logo.png') }}" alt="W68 Autoparts"></div>
                        </div>
                    </div>
                @endif
            </div>
    ...
    <script src="{{ asset('js/w68-storefront.js') }}?v=20260911-v5" defer></script>
</body>
</html>
