...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/w68-storefront.css') }}?v=20260911-v6">
</head>
<body>
            ...
            <div class="hero-main hero-product-carousel" id="hero-new-items" data-slide-carousel data-interval="2000">
                            ...
                            <div class="hero-product-visual">
                                ...
                                <div class="hero-product-image-wrap white-bg-blend">
                                    <img
                                        ...
                                        src="{{ $product->image_url ?: asset('build/assets/images/sidebar_logo.png') }}"
                                        alt="{{ $product->display_description ?: $product->name }}"
                                        loading="lazy"
                                        onerror="this.src='{{ asset('build/assets/images/sidebar_logo.png') }}'"
                                    >
                                </div>
                            </div>
                        </article>
                ...
                @if (count($newItems))
                    <div class="hero-dots" data-slide-dots aria-label="New item carousel">
                        <button type="button" class="hero-dot active" data-slide-dot="0" aria-label="Show W68 logo"></button>
                        @foreach ($newItems as $index => $product)
                            <button type="button" class="hero-dot" data-slide-dot="{{ $index + 1 }}" aria-label="Show new item {{ $index + 1 }}"></button>
                        @endforeach
                    </div>
                @endif
            </div>
    ...
    <script src="{{ asset('js/w68-storefront.js') }}?v=20260911-v6" defer></script>
</body>
</html>
