...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/w68-storefront.css') }}?v=20260911-v10">
</head>
<body>
                            ...
                            <div class="hero-product-visual">
                                ...
                                <div class="hero-product-image-wrap white-bg-blend">
                                    <img
                                        ...
                                        data-hero-src="{{ route('storefront.transparent-image', ['id' => $product->id]) }}"
                                        alt="{{ $product->display_description ?: $product->name }}"
                                        loading="lazy"
                                        onerror="this.onerror=null; this.src='{{ $product->image_url ?: asset('build/assets/images/sidebar_logo.png') }}'"
                                    >
                                </div>
                            </div>
                        </article>
    ...
    <script src="{{ asset('js/w68-storefront.js') }}?v=20260911-v10" defer></script>
</body>
</html>
