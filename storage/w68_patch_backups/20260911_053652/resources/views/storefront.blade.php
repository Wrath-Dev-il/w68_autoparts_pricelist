...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/w68-storefront.css') }}?v=20260911-v11">
</head>
<body>
        ...
        <section class="shell hero-grid">
            ...
            <div class="hero-side">
                        ...
                        <div class="top-seller-slides">
                            @foreach ($topCategorySellers as $index => $seller)
                                <div class="top-seller-slide {{ $index === 0 ? 'active' : '' }}" data-slide>
                                    <a class="hero-side-product-link" href="{{ route('storefront', ['q' => $seller->product->product_code]) }}#product-{{ $seller->product->id }}" title="View {{ $seller->product->name }}">
                                        ...
                                        <div class="top-seller-product">
                                            ...
                                            <div>
                                                ...
                                                @unless (str_starts_with(strtoupper((string) $seller->product->product_code), 'SHOPEE-'))
                ...
                <article class="promo-card fast-lookup-card">
                    ...
                    @if ($fastLookup)
                        <a class="fast-lookup-product hero-side-product-link" href="{{ route('storefront', ['q' => $fastLookup->product_code]) }}#product-{{ $fastLookup->id }}" title="View {{ $fastLookup->name }}">
                            ...
                            <div>
                                ...
                                @unless (str_starts_with(strtoupper((string) $fastLookup->product_code), 'SHOPEE-'))
            ...
            <div class="shell marketplace-section products-section">
                <div class="section-heading product-heading">
                    <div>
                        ...
                        <h2>{{ $search !== '' || $brand !== '' || $description !== '' || $descriptionSearch !== '' || $brandSearch !== '' || $applicationSearch !== '' || $partNumberSearch !== '' || $positionSearch !== '' ? 'Filtered Products' : 'Recommended for You' }}</h2>
                    ...
                    <div class="product-grid">
                        @foreach ($products as $product)
                            ...
                            <article
                                ...
                                data-product-code="{{ str_starts_with(strtoupper((string) $product->product_code), 'SHOPEE-') ? '' : $product->product_code }}"
                            >
                                ...
                                <div class="product-info">
                                    @unless (str_starts_with(strtoupper((string) $product->product_code), 'SHOPEE-'))
    ...
    <footer id="footer">
        <div class="shell w68-contact-footer">
            ...
            <div class="footer-contact-block">
                ...
                >
                    48 Timothy St. Multinational Village Parañaque City
                </a>
            </div>

            <div class="footer-contact-block">
                <strong>Customer Support</strong>
                <a href="tel:+63285539092">Tel. Nos. 8553-9092 / 8829-0480</a>
                <a href="tel:+639173239605">Mobile No. 0917-3239-605</a>
                <a href="tel:+639498818468">Mobile/Viber. 0949-8818-468</a>
            </div>
        </div>
    </footer>
        ...
        <section class="product-view-card" role="dialog" aria-modal="true" aria-labelledby="product-view-title">
            ...
            <div class="product-view-content">
                ...
                <div class="product-view-details">
                    <div>
                        <span>Description</span>
                        <strong data-product-modal-description>—</strong>
                    </div>
                    <div>
                        <span>Brand</span>
                    ...
                    <div data-product-modal-code-row>
    ...
    <script src="{{ asset('js/w68-storefront.js') }}?v=20260911-v11" defer></script>
</body>
</html>
