...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/w68-storefront.css') }}?v=20260911-v13">
</head>
<body>
                    ...
                    <article class="hero-product-slide hero-logo-slide active" data-slide>
                        <div class="hero-logo-slide-copy">
                            ...
                            <div class="hero-actions">
                                <a class="primary-action" href="{{ route('storefront') }}#products">Browse Products</a>
                                <a class="secondary-action" href="{{ route('storefront') }}#products">Shop Parts</a>
                            </div>
                        </div>
                            ...
                            <div class="hero-product-copy hero-product-copy-minimal">
                                ...
                                <div class="hero-actions">
                                    <a
                                        ...
                                        href="{{ route('storefront', array_filter([
                                            'product_code' => $product->display_product_code ?? '',
                                        ])) }}#product-{{ $product->id }}"
                                    >
                                        Browse Products
                                    </a>
    ...
    <script src="{{ asset('js/w68-storefront.js') }}?v=20260911-v13" defer></script>
</body>
</html>
