...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/w68-home.css') }}?v=20260912-v36">
    <script src="{{ asset('js/w68-home.js') }}?v=20260912-v36" defer></script>
</head>
        ...
        <div class="customer-nav-shell">
            <div class="nav-main-content" data-nav-main>
                ...
                <form class="nav-filter-form" action="{{ route('home') }}#products" method="GET" data-nav-filter-form data-loading-form>
                    <div class="nav-section-title">
                        ...
                        <small>Choose a filter or type directly into the search fields below.</small>
                    </div>
            ...
            <div class="nav-collapsed-content" data-nav-collapsed-summary aria-hidden="true">
                ...
                <div class="collapsed-click-hint">
                    <b>FILTERS ARE ACTIVE</b>
                    <span>Click / tap this bar to open filters and search.</span>
                </div>
            </div>
