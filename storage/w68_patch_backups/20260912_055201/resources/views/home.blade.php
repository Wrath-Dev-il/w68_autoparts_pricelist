...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/w68-home.css') }}?v=20260912-v37">
    <script src="{{ asset('js/w68-home.js') }}?v=20260912-v37" defer></script>
</head>
<body data-recommend-url="{{ route('home.search-suggestions') }}">
    @php
        ...
        <div class="customer-nav-shell">
            <div class="nav-main-content" data-nav-main>
                <div class="nav-top-row">
                    ...
                    <div class="nav-account">
                        <img class="nav-profile-picture" src="{{ route('home.profile-picture') }}" alt="{{ $profileName }} profile picture">
                ...
                <form class="nav-filter-form" action="{{ route('home') }}#products" method="GET" data-nav-filter-form data-loading-form>
                    <div class="nav-section-title">
                        <span>FILTER PRODUCTS</span>
                        <small>Choose a filter first. Use the Search Products extension when you need a more specific lookup.</small>
                    </div>

                    <div class="nav-filter-grid">
                        <label>
                            <span>Brand</span>
                            <select data-filter-select data-filter-field="brand">
                        ...
                        <label>
                            ...
                            <select data-filter-select data-filter-field="description">
                        ...
                        <label>
                            <span>Position</span>
                            <select data-filter-select data-filter-field="position">
                        ...
                        <label>
                            ...
                            <select data-filter-select data-filter-field="application">
                    ...
                    <button
                        type="button"
                        class="nav-search-extension-toggle"
                        data-nav-search-toggle
                        aria-expanded="false"
                    >
                        <span>
                            <b>NEED A MORE SPECIFIC PART?</b>
                            <small>Click / tap here to extend Search Products</small>
                        </span>
                        <strong aria-hidden="true">SEARCH PRODUCTS</strong>
                    </button>

                    <div class="nav-search-extension" data-nav-search-extension hidden>
                        <div class="nav-search-divider"><span>SEARCH PRODUCTS</span></div>
            ...
            <div class="nav-collapsed-content" data-nav-collapsed-summary aria-hidden="true">
                <div class="collapsed-summary-copy">
                    <small>ACTIVE FILTER / SEARCH</small>
                ...
                <div class="collapsed-click-hint">
                    <b>CLICK / TAP THIS NAVIGATION BAR</b>
                    <span>Open filters first, then extend Search Products when needed.</span>
                </div>
            </div>
