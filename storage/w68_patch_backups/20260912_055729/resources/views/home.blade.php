...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/w68-home.css') }}?v=20260912-v38">
    <script src="{{ asset('js/w68-home.js') }}?v=20260912-v38" defer></script>
</head>
        ...
        <div class="customer-nav-shell">
            <div class="nav-main-content" data-nav-main>
                ...
                <form class="nav-search-form" action="{{ route('home') }}#products" method="GET" data-loading-form>
                    <div class="nav-section-title">
                        ...
                        <small>
                            Search any W68 product detail. Product Code and Part Number recommendations use the exact product image;
                            shared Brand, Application, Position, and Description values use a random matching product image.
                        </small>
                    </div>
            ...
            <div class="nav-collapsed-content" data-nav-collapsed-summary aria-hidden="true">
                ...
                <div class="collapsed-click-hint">
                    ...
                    <span>Open Search Products and continue your lookup.</span>
                </div>
            </div>
