...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/w68-home.css') }}?v=20260912-v40">
    <script src="{{ asset('js/w68-home.js') }}?v=20260912-v40" defer></script>
</head>
<body data-search-suggestion-url="{{ route('home.search-suggestions') }}">
    @php
